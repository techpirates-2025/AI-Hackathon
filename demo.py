...
if uploaded_file is not None:
    ...
    file_path = "orders.csv"  # Default CSV in working directory

# =======================
# LLM CONFIGURATION
# =======================
llm = ChatOpenAI(
    base_url="https://genailab.tcs.in/chat/completions",
    # model="azure_ai/genailab-maas-DeepSeek-V3-0324",
    model="azure_ai/genailab-maas-gpt-4.1",
    api_key="sk-SshF5PVHJX2hTcQMjoW0zw",  # TODO: replace with environment var in prod
    http_client=client,
)
